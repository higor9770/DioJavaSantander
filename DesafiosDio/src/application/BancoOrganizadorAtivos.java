...
uma lista de ativos que será informada pelos usuários. Os ativos são representados por strings que representam 
...
quantidade de ativos que o usuário possui. Em seguida, 
o usuário deverá  informar, em linhas separadas, 
...
public class BancoOrganizadorAtivos {
  public static void main(String[] args) {
    ...
    System.out.println("A ordem dos ativos são: ");
