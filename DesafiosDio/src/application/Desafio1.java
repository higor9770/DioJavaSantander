...
uma entrada que representa o saldo atual do funcionário, e após, 
seja informado o valor de duas transações, sendo elas: um depósito e um saque. 
O programa deve atualizar o saldo com base nas transações e exibir o saldo final.

Informação: As transações de depósito e retirada devem ser 
tratadas como valores positivos e negativos, respectivamente, 
...
Saída:
 Um número decimal que representa o saldo atualizado na conta bancária após o
...
public class Desafio1 {
    public static void main(String[] args) {
        ...
        System.out.print("Digite o saldoAtual: ");
        double saldoAtual = scanner.nextDouble();
        
        System.out.print("Digite o valorDeposito: ");
        double valorDeposito = scanner.nextDouble();
        
        System.out.print("Digite o valorRetirada: ");
